## 系統方塊圖
![](https://github.com/01053007/MCU-project/blob/main/images/PID.png?raw=true)
...
## 監控序列埠
```
Heading Target = 	219.00
Motor Pins assigned...
attachMotors: init MCPWM Motor 0
attachMotors: init MCPWM Motor 1
attachMotors: Configuring Initial Parameters of MCPWM...
attachMotors: MCPWM initialized
Connecting to err
......
WiFi connected.
IP address: 
192.168.54.209
HTTP server started
motorStop: Motor 0 stop
motorStop: Motor 1 stop
Yaw:	219.00	219.00
Power:	255	0
Yaw:	219.00	219.00
Power:	255	0
